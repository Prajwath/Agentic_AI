...
class URLNavigator:
    ...
    def detect_url_intent(self, message, context=None):
        ...
        bg_file_triggers = bg_file_config.get("triggers", []) + ["create bg with file", "मैं एक नया बीजी बनाना चाहता हूँ", "नया बीजी बनाएं"]
        ...
        # LC Creation (simplified, add Hindi trigger if needed)
